...
export const HomeAttendant = () => {
  ...
  const [selectedCodePracticante, setSelectedUserControls] = useState([])
  ...
  const handleOnClick = (set) => {
    ...
    setForm({
      ...
      codePracticante: set.codePracticante,
      codePracticControl: set.codePracticControl
    })
    getAllData(idMana)
  }
  ...
  return (
    <div>
        ...
        <form className="form-control" action="" onSubmit={handleOnSubmit}>
          <div className="row">
            <div className="p-4">
              ...
              <select name="evaluations" className="form-select" value={form.evaluations} onChange={handleOnChange}>
            ...
            <div className="col p-4">
              ...
              <select disabled required className="form-select" name="codePracticante" value={form.codePracticante} onChange={handleUserChange} id="">
            ...
            <div className=" col p-4">
              ...
              <select disabled required name="codePracticControl" className="form-select" value={form.codePracticControl} onChange={handleOnChange}>
      ...
      <div className="m-4">
        <div className=' w-100'>
          <h4>CONTROL DIARIO DE PRÁCTICA (selecciona una tabla para evaluar)</h4>
          <table className=' table table-hover border shadow-sm p-3 mb-5 bg-body rounded'>
            <thead className='thead-dark'>
              <tr>
                ...
                <th scope="col">CodePracticante</th>
                <th scope="col">CodeControl</th>
              </tr>
            </thead>
            <tbody>
              {
                user.map((index) => (
                  <tr key={index.codeUser} onClick={() => handleOnClick(index)}>
                    ...
                    <td>{index.codePracticante}</td>
                    <td>{index.codePracticControl}</td>
                  </tr>
                ))
              }
            </tbody>
